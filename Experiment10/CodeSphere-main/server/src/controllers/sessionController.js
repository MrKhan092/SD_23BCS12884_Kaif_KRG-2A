...
export async function createSession(req,res){
    try{
        ...
        console.log("Error in creatingSession controller:",error.message);
        res.status(500).json({
...
export async function joinSession(req,res){
    try{
        ...
        if(session.participant) return res.status(409).json({
        ...
        console.log("Error on joinSession controller:",error.message);
        res.status(500).json({
            message:"Internal Server Error"
        });
    }
